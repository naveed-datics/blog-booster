...
const ENSURE_TABLE_SQL = `
  ...
  ALTER TABLE article_drafts ADD COLUMN IF NOT EXISTS answer_json JSONB;
`;
  ...
  const result = await query(
    `INSERT INTO article_drafts
       (website_id, trend_id, celebrity_name, draft_html, draft_title, image_url,
        pipeline_status, last_error, retry_after, publish_attempts, answer_json, updated_at)
     VALUES ($1, $2, $3, $4, $5, $6, $7, NULL, $8, 0, $9, NOW())
...
export async function claimDueDrafts(limit = 2, { ignoreRetryAfter = false } = {}) {
  await ensureArticleDraftsTable();
